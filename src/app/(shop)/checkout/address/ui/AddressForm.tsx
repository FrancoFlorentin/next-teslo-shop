...
import { deleteUserAddress, setUserAddresss } from "@/actions";
...
type Props = {
  countries: Country[];
  userStoredAddress?: Address | {}; // El partial dice que todas las propiedades de Address ahora son opcionales
}
...
export function AddressForm({ countries, userStoredAddress }: Props) {
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    if (rememberAddress) { 
      await setUserAddresss(rest as Address, session!.user.id)
    } else {
