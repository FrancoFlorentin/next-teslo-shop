...
import type { CategoryServer, Product, ProductImage as ProductWithImage } from "@/interfaces";
            ...
            
            {
              sizes.map( size => (
                ...
                <div 
                  ...
                  className={
                    clsx(
                      "p-2 border crsor-pointer rounded-md cursor-pointer hover:bg-blue-300 mr-2 mb-2 w-14 transition-all text-center",
                      {
